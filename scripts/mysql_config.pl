...
$flags->{cflags}  = [@{$flags->{include}},split(" ",' -fPIC -Wall  -O3 -g -fabi-version=2 -fno-omit-frame-pointer -fno-strict-aliasing -DDBUG_OFF')];
$flags->{cxxflags}= [@{$flags->{include}},split(" ",' -fPIC -Wall   -O3 -g -fabi-version=2 -fno-omit-frame-pointer -fno-strict-aliasing -DDBUG_OFF')];
